...
For app code, load the matching `yarah` app skill provider guide:

- `skills/yarah/payments/stripe.md`
- `skills/yarah/payments/razorpay.md`
...
- `sync` mirrors provider catalog/customers/subscriptions/transactions into Yarah; it does not replace webhook delivery.
- Runtime checkout/order/subscription/customer portal calls belong in the app through `@yarahdev/sdk`, not CLI commands.
